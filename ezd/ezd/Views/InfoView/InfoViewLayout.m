...
@interface InfoViewLayout ()<UITableViewDelegate,UITableViewDataSource>



@end

@implementation InfoViewLayout

- (instancetype)initWithFrame:(CGRect)frame {
    self = [super initWithFrame:frame];
    if (self) {
        self.userInteractionEnabled = YES;
        [self.infoArray addObjectsFromArray:@[@"0",@"9",@"8",@"7",@"6",@"5",@"4",@"3",@"2",@"1"]];
        [self addSubview:self.infoTableView];
        self.infoTableView.myMargin = 0;
    }
    return self;
}
